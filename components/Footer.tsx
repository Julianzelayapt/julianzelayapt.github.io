...
const Footer: React.FC<{ t: any }> = ({ t }) => {
  return (
    <footer className="bg-white pt-12 pb-8 px-6 border-t border-black/[0.03]">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          <div className="animate-from-left">
            ...
            <p className="text-ios-gray max-w-xs text-xs font-bold leading-relaxed uppercase tracking-tight mb-6">
              {t.contact_footer}
            </p>
          ...
          <div className="flex flex-wrap gap-x-16 gap-y-8 animate-from-right delay-1">
             <div className="space-y-4">
