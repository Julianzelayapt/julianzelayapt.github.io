  ...
  return (
    <div className="min-h-screen bg-white selection:bg-kaki-100 selection:text-ios-text">
      ...
      <main>
        ...
        <section className="py-16 px-6 bg-kaki-50">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="flex-1 space-y-10 animate-slide">
                <h3 className="text-4xl md:text-6xl font-black text-ios-text uppercase tracking-tighter leading-none mb-10">{t.testimonials}</h3>
        ...
        <section className="py-24 px-6 text-center bg-ios-text text-white">
          <div className="max-w-4xl mx-auto animate-slide">
            ...
            <button className="bg-white text-ios-text px-16 py-6 rounded-ios font-black text-[10px] uppercase tracking-[0.3em] hover:bg-kaki-50 transition-all shadow-2xl hover-zoom">
              {t.cta_btn}
            </button>
          </div>
        </section>
